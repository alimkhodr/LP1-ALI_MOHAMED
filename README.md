...
90) Faça um algoritmo para ler dois vetores V1 e V2 de 15 números cada. Calcular e escrever a 
quantidade de vezes que V1 e V2 possuem os mesmos números e nas mesmas posições. 

91) Faça um algoritmo para ler um vetor de 30 números. Após isto, ler mais um número qualquer, 
